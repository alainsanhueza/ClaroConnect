...
public class Get  implements java.io.Serializable {
    ...
    private com.ericsson.schemas.cai3g1_2.GetRequestMODefinition MOAttributes;
    ...
    public Get(
           ...
           com.ericsson.schemas.cai3g1_2.GetRequestMODefinition MOAttributes,
    ...
    /**
     * Gets the MOType value for this Get.
     * 
     * @return MOType
     */
    ...
    /**
     * Sets the MOType value for this Get.
     * 
     * @param MOType
     */
    ...
    /**
     * Gets the MOId value for this Get.
     * 
     * @return MOId
     */
    ...
    /**
     * Sets the MOId value for this Get.
     * 
     * @param MOId
     */
    ...
    /**
     * Gets the MOAttributes value for this Get.
     * 
     * @return MOAttributes
     */
    public com.ericsson.schemas.cai3g1_2.GetRequestMODefinition getMOAttributes() {
        return MOAttributes;
    }


    /**
     * Sets the MOAttributes value for this Get.
     * 
     * @param MOAttributes
     */
    public void setMOAttributes(com.ericsson.schemas.cai3g1_2.GetRequestMODefinition MOAttributes) {
        this.MOAttributes = MOAttributes;
    }


    /**
     * Gets the extension value for this Get.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this Get.
     * 
     * @param extension
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ericsson.com/cai3g1.2/", ">Get"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.ericsson.com/cai3g1.2/", "GetRequestMODefinition"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
