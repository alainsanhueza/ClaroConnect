...
public class SetResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the MOAttributes value for this SetResponse.
     * 
     * @return MOAttributes
     */
    ...
    /**
     * Sets the MOAttributes value for this SetResponse.
     * 
     * @param MOAttributes
     */
    ...
    /**
     * Gets the extension value for this SetResponse.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this SetResponse.
     * 
     * @param extension
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ericsson.com/cai3g1.2/", ">SetResponse"));
