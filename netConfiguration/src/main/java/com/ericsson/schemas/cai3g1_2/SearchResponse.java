...
public class SearchResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the MOId value for this SearchResponse.
     * 
     * @return MOId
     */
    ...
    /**
     * Sets the MOId value for this SearchResponse.
     * 
     * @param MOId
     */
    ...
    /**
     * Gets the extension value for this SearchResponse.
     * 
     * @return extension
     */
    ...
    /**
     * Sets the extension value for this SearchResponse.
     * 
     * @param extension
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.ericsson.com/cai3g1.2/", ">SearchResponse"));
